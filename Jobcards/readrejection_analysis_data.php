...
if($num>0){
   ...
   // $Jobcard_arr=array();
    ...
    while ($row = $stmt1->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($Rejection_analysis_data_arr1, $Rejection_analysis_data_item1);
   ...
   $result = array_merge($Rejection_analysis_data_arr1,$Rejection_analysis_data_arr);
    ...
    $status['data'] =$result;
    // $status['total'] =$Rejection_analysis_data_arr1;
