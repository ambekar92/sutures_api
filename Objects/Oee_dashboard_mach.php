...
class Oee_dashboard_mach{
 ...
 function read(){
            ...
            $mach_code = $data['mach_code'];
              ...
              $query = "SELECT tb_o_workcenter.wrk_ctr_code,tb_o_workcenter.wrk_ctr_desc,tb_m_machine.mach_code,tb_m_machine.mach_desc,ifnull(js.batch_no,'-') as batch_no,ifnull(jb.fg_code,'-')as fg_code,if((js.status_code != 803 and js.oper_status != 807),U.name,'-') as operator,if((js.status_code != 803 and js.oper_status != 807),U.emp_id,'-') as operator_id,if(me.on_off_status = 1 or me.on_off_status is null,1,0) as on_off,SEC_TO_TIME(ifnull(o.plnd_prod_time,0)) as plnd_prod_time,SEC_TO_TIME(ifnull(o.run_time,0)) as run_time,SEC_TO_TIME(ifnull(o.idle_time,0)) as idle_time, ifnull(o.target_prod,0)as target_prod,ifnull(o.actual_prod,0)as actual_prod,round((ifnull(o.total_count,0)/12),2)as total_count,round((ifnull(o.ok_qty,0)/12),2) as ok_qty,round((ifnull(o.rej_qty,0)/12),2) as rej_qty,ifnull(o.availability_perc,0)as availability_perc,ifnull(o.performance_perc,0)as performance_perc,ifnull(o.quality_perc,0) as quality_perc,ifnull(o.oee_perc,0) as oee_perc  FROM  tb_m_machine
