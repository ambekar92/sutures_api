...
ORDER BY `tb_t_oee`.`date_`  DESC ";
   ...
   WHERE date_ > DATE_SUB('$date', INTERVAL 11 MONTH) AND date_ <= '$date' GROUP BY tb_o_workcenter.wrk_ctr_code,_month";
    ...
    $query = "SELECT o.date_,o.wrk_ctr_code,tb_o_workcenter.wrk_ctr_desc,o.mach_code,tb_m_machine.mach_desc,SEC_TO_Time(o.plnd_prod_time)as plnd_prod_time,SEC_TO_Time(o.run_time)as run_time,SEC_TO_Time(o.idle_time)as idle_time,'0' target_prod,'0' actual_prod,round((o.total_count/12),2)as total_count,round((o.ok_qty/12),2)as ok_qty,round((o.rej_qty/12),2)as rej_qty,ifnull(((sum(o.run_time)/sum(o.plnd_prod_time))*100),0) as availability_perc,ifnull(((sum(o.target_dur)/sum(o.run_time))*100),0)as performance_perc,ifnull(((sum(o.ok_qty)/sum(o.total_count))*100),0)as quality_perc,ifnull(((sum(o.run_time)/sum(o.plnd_prod_time))*(sum(o.target_dur)/sum(o.run_time))*(sum(o.ok_qty)/sum(o.total_count))),0)*100 as oee_perc FROM `tb_t_oee` o
...
where o.mach_code = '$mach_code' and date_ > DATE_SUB('$date', INTERVAL 30 DAY) AND date_ <= '$date' GROUP BY o.date_";
   }else if($wrk_ctr_code != 'ALL' AND $mach_code != 'ALL' AND $select == 'WEEKLY' ) {
    $query = "SELECT concat('WEEK ',WEEK(date_,0),' ( ',DATE_FORMAT(MIN(date_),'%d-%m-%Y'),' - ',DATE_FORMAT(MAX(date_),'%d-%m-%Y'),' )') as weekly,WEEK(date_,0) as weeks,o.wrk_ctr_code,tb_o_workcenter.wrk_ctr_desc,o.mach_code,tb_m_machine.mach_desc,SEC_TO_Time(SUM(o.plnd_prod_time)) as plnd_prod_time ,SEC_TO_Time(SUM(o.run_time)) as run_time,SEC_TO_Time(SUM(o.idle_time))as idle_time,'0' as target_prod,'0' as actual_prod,round((SUM(o.total_count)/12),2) as total_count, round((SUM(o.ok_qty)/12),2) as ok_qty,round((SUM(o.rej_qty)/12),2) as rej_qty,ifnull(((sum(o.run_time)/sum(o.plnd_prod_time))*100),0) as availability_perc,ifnull(((sum(o.target_dur)/sum(o.run_time))*100),0)as performance_perc,ifnull(((sum(o.ok_qty)/sum(o.total_count))*100),0)as quality_perc,ifnull(((sum(o.run_time)/sum(o.plnd_prod_time))*(sum(o.target_dur)/sum(o.run_time))*(sum(o.ok_qty)/sum(o.total_count))),0)*100 as oee_perc FROM `tb_t_oee` o
    left OUTER join tb_t_job_status js on js.to_dept = o.wrk_ctr_code and js.to_mach = o.mach_code and js.status_code = 802 and js.oper_status=806
    left join users U on js.emp_id = U.emp_id
    left join tb_m_jobcard jb on js.batch_no = jb.batch_no
    join tb_o_workcenter on tb_o_workcenter.wrk_ctr_code = o.wrk_ctr_code
...
where o.mach_code = '$mach_code' and date_ > DATE_SUB('$date', INTERVAL 4 WEEK) AND date_ <= '$date' GROUP by weeks";
    ...
    $query = "SELECT MONTH(date_) as _month, DATE_FORMAT(date_, '%b''%y') as month_desc,o.wrk_ctr_code,tb_o_workcenter.wrk_ctr_desc,o.mach_code,tb_m_machine.mach_desc,SEC_TO_Time(SUM(o.plnd_prod_time)) as plnd_prod_time ,SEC_TO_Time(SUM(o.run_time)) as run_time,SEC_TO_Time(SUM(o.idle_time))as idle_time,'0' target_prod,'0' as actual_prod,round((SUM(o.total_count)/12),2) as total_count, round((SUM(o.ok_qty)/12),2) as ok_qty,round((SUM(o.rej_qty)/12),2) as rej_qty,ifnull(((sum(o.run_time)/sum(o.plnd_prod_time))*100),0) as availability_perc,ifnull(((sum(o.target_dur)/sum(o.run_time))*100),0)as performance_perc,ifnull(((sum(o.ok_qty)/sum(o.total_count))*100),0)as quality_perc,ifnull(((sum(o.run_time)/sum(o.plnd_prod_time))*(sum(o.target_dur)/sum(o.run_time))*(sum(o.ok_qty)/sum(o.total_count))),0)*100 as oee_perc FROM `tb_t_oee` o
    left OUTER join tb_t_job_status js on js.to_dept = o.wrk_ctr_code and js.to_mach = o.mach_code and js.status_code = 802 and js.oper_status=806
    left join users U on js.emp_id = U.emp_id
    left join tb_m_jobcard jb on js.batch_no = jb.batch_no
    join tb_o_workcenter on tb_o_workcenter.wrk_ctr_code = o.wrk_ctr_code
