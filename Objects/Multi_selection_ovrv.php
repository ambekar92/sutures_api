...
class multi_selection_ovrv{
    ...
    IFNULL(COUNT(DISTINCT(CASE WHEN js.status_code = 803 and js.oper_status = 807 and  js.oper_code = jt.oper_code and js.status_code !=804  THEN js.batch_no END)), 0)as Completed_not_ack,
