...
group by D.wrk_ctr_code";
 ...
 function read1(){
   ...
   function read2(){
    ...
    LEFT JOIN  (SELECT work_ctr_code,process,today_plan,daily_target from  tb_t_prod_dash_h where date_ = '$date') A on tb_o_workcenter.wrk_ctr_code = A.work_ctr_code";
