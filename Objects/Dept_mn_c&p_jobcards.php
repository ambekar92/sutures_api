...
class Dept_mn_cp_jobcards{
 ...
 function read(){
             ...
             $year = $data['year'];
              ...
              where present_dept = '$wrk_ctr_code' and status_code = 803 and oper_status = 807 and MONTH(tb_t_job_card_trans.updated_at) = '$month' AND YEAR(tb_t_job_card_trans.updated_at) = '$year' and tb_m_jobcard.batch_status is null  GROUP by batch_no order by tb_t_job_card_trans.updated_at DESC";
