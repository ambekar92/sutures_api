...
class ageing{
    ...
    function read(){
        ...
        $data = json_decode(file_get_contents('php://input'), true);
            ...
            if($month != 'NULL' AND $plan != 'NULL' AND $type != 'NULL' ) {
                $condition = "AND jc.plan = '$month'  AND jc.plan_code = '$plan' AND jc.urgent = '$type' ";
            }elseif ($month != 'NULL' AND $plan != 'NULL' AND $type == 'NULL' ){
                $condition = "AND jc.plan = '$month'  AND jc.plan_code = '$plan'";
            }elseif ($month != 'NULL' AND $plan == 'NULL' AND $type == 'NULL' ){
                $condition = "AND jc.plan = '$month'";
            }elseif ($month == 'NULL' AND $plan == 'NULL' AND $type == 'NULL' ){
                $condition = " ";
            }
